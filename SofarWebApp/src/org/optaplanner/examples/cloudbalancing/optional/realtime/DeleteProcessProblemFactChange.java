...
public class DeleteProcessProblemFactChange implements ProblemFactChange<CloudBalance> {
    ...
    public DeleteProcessProblemFactChange(CloudRoute process) {
    ...
    public void doChange(ScoreDirector<CloudBalance> scoreDirector) {
        ...
        CloudRoute workingProcess = scoreDirector.lookUpWorkingObject(process);
        ...
        cloudBalance.getRouteList().remove(workingProcess);
